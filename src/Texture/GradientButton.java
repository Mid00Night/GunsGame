...
public class GradientButton extends JButton implements MouseListener {
     ...
     */
    private static final Color DEFAULT_COLOR_1 = new Color(195, 138, 61);
    /**
     * The second color of the Gradient background which acts as Default.
     */
    private static final Color DEFAULT_COLOR_2 = new Color(216, 168, 70);
    /**
    ...
    public void mousePressed(MouseEvent e) {
        ...
        this.setFont(new Font("Felix Titling", 1, 14));
       this.setForeground(Color.getHSBColor(45, 46, 93));
    }
